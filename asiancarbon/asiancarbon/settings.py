"""
Django settings for asiancarbon project.
...
WSGI_APPLICATION = 'asiancarbon.wsgi.application'
...
EMAIL_HOST_PASSWORD = os.environ['EAMIL_PASSWORD']
EMAIL_USE_TLS = True
